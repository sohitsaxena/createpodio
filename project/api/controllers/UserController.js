...
// ***********************cto access an organization id**********************
  organizationid: function(req, res){
         var rp = require('request-promise');
         var options = {
                    // method: 'GET',
                     uri: 'https://api.podio.com/org?oauth_token=592619fd277240218fe4f3db5d0d24a3',
                     json: true
...
rp(options)
 ...
 createpodioapp:function(req, res){
     
      var userid = "3165421";
      var spaceName = "demospace";
      var spaceID = "4063280";
      var authtoken = "592619fd277240218fe4f3db5d0d24a3"

      podioAPI.createApp(spaceID, authtoken, sails.config.globals.taxTypePayLoad, function(err, data){
        if(err){
                  sails.log(err);
                  // res.json("error", err);
                }
      ...
      // rp({
//                uri: 'https://api.podio.com/org?oauth_token=3245161346f74a14b66511e5fe3cc1a7',
//               method: "GET",
//                json: true,
//               //  headers: {
//               //     "content-type": "application/json"
...
//           .then(function (body) {
//            if(body.body){
//             User.orgid(body.body, function(err, data){
//               if(err){
//                 sails.log(err);
//                 console.err(err);
//                 res.json("Error",err);
